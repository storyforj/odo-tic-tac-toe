...
export class Enemy extends Phaser.GameObjects.Sprite {
  ...
  private enemyTint: number = 0;
  private enemyType: string = 'octopus';
  private hurtingTime: number = 200;
  private isHurt: boolean = false;
  private lives: number = 1;
  private reloadTime: number = 9000;
  private valueKill: number = 20;
  ...
  private initVariables(params: EnemyOptions): void {
